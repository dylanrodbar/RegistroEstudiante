...
public class ConsultaConTitulo extends javax.swing.JFrame {
    RegistroEstudiante registro = MenuRegistro.getRegistro();
    DefaultTableModel modelo;
    public ConsultaConTitulo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        labelMenu.setBounds(609, 37, 89, 70);
        ...
        labelConsulta.setBounds(483, 37, 89, 70);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ArrayList<Estudiante> estudiantes = registro.getEstudiantesConTitulo();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaConTitulo().setVisible(true);
            }
        });
    }
